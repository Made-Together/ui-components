...
import {
  BasicTickerExample,
  DynamicTickerExample,
  FadesTickerExample,
  FixedWidthTickerExample,
  NotificationTickerExample,
  PlayerRowTickerExample,
  ShortTextTickerExample,
  SpeedsTickerExample,
} from "./_examples";
...
<ComponentShowcase preview={<BasicTickerExample />}>
...
<ComponentShowcase preview={<ShortTextTickerExample />}>
...
<ComponentShowcase preview={<FixedWidthTickerExample />}>
...
<ComponentShowcase preview={<SpeedsTickerExample />}>

```tsx
<Ticker.Root scrollSpeed={25}>…</Ticker.Root>
<Ticker.Root scrollSpeed={50}>…</Ticker.Root>
<Ticker.Root scrollSpeed={100}>…</Ticker.Root>
```
...
<ComponentShowcase preview={<FadesTickerExample />}>

```tsx
<Ticker.Root fadeWidth={12}>…</Ticker.Root>
<Ticker.Root fadeWidth={48}>…</Ticker.Root>
```
...
<ComponentShowcase preview={<DynamicTickerExample />}>
...
<ComponentShowcase preview={<PlayerRowTickerExample />}>
...
<ComponentShowcase preview={<NotificationTickerExample />}>
...
- `Ticker.Root` sets `aria-live="polite"` so screen readers
