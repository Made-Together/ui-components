...
| ------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------ |
| `options`     | `undefined` | Embla [options](https://www.embla-carousel.com/api/options/) (e.g. `loop`, `align`, `dragFree`, `axis`, `slidesToScroll`). |
| `plugins`     | `undefined` | Embla [plugins](https://www.embla-carousel.com/plugins/). If you supply your own `Autoplay()` here, the `autoplay` prop is ignored. |
